...
export const deleteProduct = createAction(DELETE_PRODUCT, (product: ProductInfo) => {
    return {
        payload:  {
            product: product,
            message: `Deleting product with ID: ${product.ProductId}`
        }
    };
});
export const deleteProductSuccess = createAction(DELETE_PRODUCT_SUCCESS, (product: ProductInfo) => {
    return {
        payload:  {
             product: product,
            message: `Product with ID: ${product.ProductId} deleted successfully`
        }
    };
});